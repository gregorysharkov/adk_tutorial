...
def main():
    ...
    tasks = [
        (
            research_agent,
            "Analyze the current market trends in artificial intelligence and machine learning for 2024",
            "Focus on enterprise adoption and emerging technologies",
        ),
        (
            data_analyst,
            "Create a statistical summary of AI adoption rates across different industries",
            "Include growth projections and key metrics",
        ),
        (
            content_writer,
            "Write a comprehensive blog post about AI trends based on the research findings",
